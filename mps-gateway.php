...
define('MPS_PLUGIN_VERSION', '2.4.6');
...
add_action('plugins_loaded', function() {
    ...
    class MPS_Settings_Gateway extends WC_Payment_Gateway {
        ...
        public function admin_options(): void {
            ...
            // Only show the K-Processor callback URL if this merchant actually has a
            // K-Processor gateway assigned — otherwise it's just confusing noise.
            $has_k_processor = false;
            foreach (MPS_Portal_Client::get_gateways() as $mps_gw) {
                if (($mps_gw['processor_code'] ?? '') === 'k') { $has_k_processor = true; break; }
            }
